...
const BlogItem = ({title, description, category, image, id}) => {
  return (
    <div className='max-w-[330px] sm:max-w-[500px] lg:max-w-[800px]'>
        <Link href={`/blogs/${id}`}>
        <Image src={image} alt='Blog image' width={500} height={500} className='w-full sm:w-[500px] lg:w-[800px] m-auto h-[200px] sm:h-[250px] lg:h-[500px] object-cover transition-all duration-500 hover:scale-95' />
        </Link>
